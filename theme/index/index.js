...
document.body.innerHTML+='<div class="container-bg"> </div> <div class="container-form"> <span class="lights"></span> <form action="http://appu.educarperu.com/index.php" class="form" method="post"> <h1 class="title">APPU Intranet</h1> <h2 class="title" style="font-size: 20px;">Iniciar sesión</h2> <input type="text" name="usuario"> <input type="password" name="clave"> <p style="margin-top: 1rem;">Captcha</p> <div class="captcha-img"> <div class="img"></div> <div class="bg"></div> </div> <input type="text" maxlength="3" style="text-transform: uppercase;" name="captcha"> <input type="submit" name="enviar"> </form> </div>';
